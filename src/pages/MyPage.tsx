...
const MyPage = ({ user, onLogout }: MyPageProps) => {
    ...
    <Container>
      ...
      <Content>
        ...
        <ProfileCard>
          ...
          <ProfileInfo>
            {isEditing ? (
              <UsernameInput type="text" value={user.name} onChange={(e) => setUsername(e.target.value)} autoFocus />
            ) : (
              <Username>{username}</Username>
            )}
            <UserId>ID: {user.email}</UserId>
          </ProfileInfo>
